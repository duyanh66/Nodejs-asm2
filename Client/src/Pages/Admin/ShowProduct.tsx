...
const ShowProduct = (props: any) => {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          <Button type="link" style={{ backgroundColor: "blue", color: "white" }} onClick={() => window.open('/Admin/Update/' + record.key)}>Sửa</Button>
          <Button type='default' style={{ backgroundColor: "red", color: 'white' }} onClick={() => OnRemove(record.key)} >Xóa</Button>
        </Space>
      ),
    },
  ];
